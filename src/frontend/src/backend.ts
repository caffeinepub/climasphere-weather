...
export class Backend implements backendInterface {
    ...
    async getAirQuality(arg0: string, arg1: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getAirQuality(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getForecast(arg0: string): Promise<string> {
        if (this.processError) {
            try {
    ...
    async getWeather(arg0: string): Promise<string> {
        if (this.processError) {
            try {
